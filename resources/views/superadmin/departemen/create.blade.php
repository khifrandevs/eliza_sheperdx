            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h4 class="card-title mb-0">Tambah Departemen</h4>
                            <p class="card-description mb-0">Form untuk menambahkan departemen baru</p>
                        </div>
                    ...
                    <form class="forms-sample" action="{{ route('superadmin.departemen.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control form-control-sm @error('deskripsi') is-invalid @enderror" rows="2">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_departemen" class="form-control form-control-sm @error('nama_departemen') is-invalid @enderror" value="{{ old('nama_departemen') }}">
