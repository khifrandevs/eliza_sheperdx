...
<head>
    ...
    <title>Edit Profil Departemen</title>
        ...
        <section class="section-header">
            <div class="page-header">
                <div class="header-title">
                    ...
                    <p class="card-description">Ubah nama departemen atau kata sandi</p>
                </div>
                <a href="{{ route('departemen.dashboard') }}" class="btn btn-light">
        ...
        <section class="section-content">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('departemen.profile.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_departemen" name="nama_departemen" 
                                   ...
                                   value="{{ old('nama_departemen', auth()->user()->nama_departemen) }}">
