            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h4 class="card-title mb-0">Edit Gereja</h4>
                            <p class="card-description mb-0">Form untuk mengedit data gereja</p>
                        </div>
                    ...
                    <form class="forms-sample" action="{{ route('departemen.gereja.update', $gereja) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nama_gereja"
                                               ...
                                               value="{{ old('nama_gereja', $gereja->nama_gereja) }}">
                                        @error('nama_gereja')
                                    ...
                                    <div class="col-sm-9">
                                        <select name="region_id" class="form-control form-control-sm @error('region_id') is-invalid @enderror">
                                            @foreach ($regions as $region)
                                                <option value="{{ $region->id }}" {{ old('region_id', $gereja->region_id) == $region->id ? 'selected' : '' }}>{{ $region->nama_region }}</option>
                                            @endforeach
                                        </select>
                                        @error('region_id')
                                            <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Pendeta yang Ditugaskan</label>
                                    <div class="col-sm-9">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <p class="text-success mb-3">
                                                        ...
                                                        Pendeta yang saat ini ditugaskan di gereja ini:
                                                    </p>
                                                    <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-2">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <br>
                                                                        <small class="text-muted">{{ $pendeta->id_akun }} - {{ $pendeta->no_telp }}</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                        ...
                                        @else
                                            <div class="alert alert-warning">
                                                ...
                                                Belum ada pendeta yang ditugaskan ke gereja ini.
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Pilih Pendeta</label>
                                    <div class="col-sm-9">
                                        @if($pendetas->count() > 0)
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                                    ...
                                                                    <div class="card-body p-3">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                   ...
                                                                                   {{ (old('pendeta_ids') && in_array($pendeta->id, old('pendeta_ids'))) || $gereja->pendetas->contains($pendeta->id) ? 'checked' : '' }}>
                                                                            <label class="form-check-label w-100" for="pendeta_{{ $pendeta->id }}">
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="flex-grow-1">
                                                                                        ...
                                                                                        @if($pendeta->gereja_id && $pendeta->gereja_id != $gereja->id)
                                                                                            <br>
                                                                                            <small class="text-warning">
                                                                                                <i class="mdi mdi-alert-circle-outline me-1"></i>
                                                                                                Saat ini ditugaskan ke: {{ $pendeta->gereja->nama_gereja }}
                                                                                            </small>
                                                                                        @elseif($gereja->pendetas->contains($pendeta->id))
                                                                                            <br>
                                                                                            <small class="text-success">
                                                                                                <i class="mdi mdi-check-circle me-1"></i>
                                                                                                Saat ini ditugaskan ke gereja ini
                                                                                            </small>
                                                                                        @endif
                                                                                    </div>
                                                                                </div>
                                                    ...
                                                    <div class="mt-3">
                                                        <small class="text-muted">
                                                            ...
                                                            Centang untuk menugaskan pendeta ke gereja ini. Hapus centang untuk melepas penugasan.
                                                        </small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="alamat"
                                                  ...
                                                  placeholder="Masukkan Alamat (Opsional)">{{ old('alamat', $gereja->alamat) }}</textarea>
                                        @error('alamat')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
