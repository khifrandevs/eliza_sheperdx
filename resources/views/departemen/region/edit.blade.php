        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('departemen.region.update', $region) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="kode_region" 
                                               ...
                                               value="{{ old('kode_region', $region->kode_region) }}">
                                        @error('kode_region')
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nama_region" 
                                               ...
                                               value="{{ old('nama_region', $region->nama_region) }}">
                                        @error('nama_region')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="deskripsi" 
                                                  ...
                                                  placeholder="Masukkan Deskripsi (Opsional)">{{ old('deskripsi', $region->deskripsi) }}</textarea>
                                        @error('deskripsi')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
