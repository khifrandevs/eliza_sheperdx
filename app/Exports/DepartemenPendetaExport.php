...
class DepartemenPendetaExport implements WithMultipleSheets
{
    protected $pendeta;
    ...
    {
        return [
            new DepartemenPendetaSummarySheet($this->pendeta),
            new DepartemenPerlawatanSheet($this->pendeta->perlawatans),
            new DepartemenPenjadwalanSheet($this->pendeta->penjadwalans),
        ];
    }
}

class DepartemenPendetaSummarySheet implements \Maatwebsite\Excel\Concerns\FromCollection, \Maatwebsite\Excel\Concerns\WithHeadings, \Maatwebsite\Excel\Concerns\WithTitle
{
    protected $pendeta;
...
class DepartemenPerlawatanSheet implements \Maatwebsite\Excel\Concerns\FromCollection, \Maatwebsite\Excel\Concerns\WithHeadings, \Maatwebsite\Excel\Concerns\WithTitle
{
...
class DepartemenPenjadwalanSheet implements \Maatwebsite\Excel\Concerns\FromCollection, \Maatwebsite\Excel\Concerns\WithHeadings, \Maatwebsite\Excel\Concerns\WithTitle
{
